...
section: The Brand
source: brand-book-v1 slide 14 (marked 🟠 in-progress in source)
status: approved
updated: 2026-08-13
---

Before we design, we decide who we're designing for. The Balizen audience is defined by three groups — but every group is reached through three shared lenses that color everything we say and make.

## 🔭 The Three Lenses (apply to all audiences)

Every Balizen customer, in some measure, sees us through these lenses. Dial each one up or down depending on who you're speaking to — but never drop one entirely.
